// compile with: "go build -o constants.exe constantsWindows.go"
// ... thereafter you can run it on a Windows system with "constants"
// ... or, having first obtained the Go compiler, ... just run the source with: "go run constantsWindows.go"
...
// Additional kluge pause -- which is not needed on a Unix System, and seems to be the only mod needed on Windws-11
        ...
        if Pnum > 0 && Pnum < 17 {  // the user has attempted to make a selection having failed to first "Hit Enter" as requested 
            fmt.Println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")  // so, rattle his chain
        }
...
// ... fly rite-past that first one and then redisplay the menu (Windows 11 does this)
        fmt.Println("Hit Enter/Return again to redisplay the menu, its a Windows thang") 
...
default: // ------------------------------------------------------------------------------
    fmt.Println("   --- we are at the switch default code, after a break option ??")
    fmt.Println("possibly, you entered a selection, having failed to first 'Hit Enter' as directed")
} // end of switch
