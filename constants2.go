...
//
            ...
            if iterInt64 == 100000000 {
                ...
                fileHandle, err1 := os.OpenFile("dataFromConstants2.txt", os.O_APPEND|os.O_WRONLY|os.O_CREATE, 0600) // append to file 
                    check(err1)                                // ... gets a file handle to dataFromConstants2.txt
...
//
//
                p("  ... working ... on doing Billions more iterations ...\n\n")
            }
//
//
