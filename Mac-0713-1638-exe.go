...
func main() {       // top-level program logic flow -- explore several ways to calculate Pi, plus THREE other constants --AMFmain-A-b
    ...
    totalLines, nonEmptyLines := 4212, 3607
...
fmt.Print(string(colorYellow), 
  ...
  string(colorGreen), " inception: ", string(colorReset), "0712-2024-v2-2023", string(colorGreen),
...
fmt.Print("15:", string(colorCyan), " Pi: ", string(colorReset), "Chudnovsky method,", string(colorYellow), " state of the art! ", string(colorReset), "But God only knows how it works\n") 
fmt.Println("        ---> uses big.Float types", string(colorYellow), "Gold Standard! \n", string(colorReset))
...
fmt.Println(string(colorYellow), "12: Display the Stats and Utilities Menu \n")
...
// --AMFmenu01a 
fmt.Println(string(colorGreen), "    build date :", string(colorCyan), date.Format("(01-02-2006)"), string(colorReset), "  inception : 0712-2024-v2-2023")
// --AMFmenu01b 
...
fmt.Println(string(colorYellow), "12: Display Stats and Utilities Menu  ")
...
fmt.Println("180:  ", string(colorRed), "Run", string(colorReset), "the endless test of case 18: (Ctrl-C will usually end it) \n")
...
func ShowxRootOfY_continuousCaller() {  // case 3:
    fmt.Print(string(colorCyan))
    var ShowxRootOfY_continuousCaller = `
// case 180:  /// this procedure is really only meant to be used for testing or illustration ... 
//                                              ... it calculates the root of all integers; and builds a file of all its results
// -- AMFxroyCCA
func xRootOfY_continuousCaller(selection int) { 
...
func ShowGottfriedWilhelmLeibniz() {  // case 6:
    fmt.Print(string(colorCyan))
    var ShowGottfriedWilhelmLeibniz = `
...
func ShowGregoryLeibniz() {  // case 3:
    fmt.Print(string(colorCyan))
    var ShowGregoryLeibniz = `
func GregoryLeibniz(selection int){  // case 7: -- AMFGregoryLeibnizA
    usingBigFloats = false
    fmt.Println("\n\nYou selected #", selection, " the Gregory-Leibniz series ...")
    fmt.Println("π = (4/1) - (4/3) + (4/5) - (4/7) + (4/9) - (4/11) + (4/13) - (4/15) ...")
...
func ShowArchimedesBig() {  // case 14:
    fmt.Print(string(colorCyan))
    var ShowArchimedesBig = `
...
func ShowEulersNumber() {  // case 9:
    fmt.Print(string(colorCyan))
    var ShowEulersNumber = `
...
func ShowErdosBorwein() {  // case 10:
    fmt.Print(string(colorCyan))
    var ShowErdosBorwein = `
...
func Shownifty_scoreBoard() {  // case 40:
    fmt.Print(string(colorCyan))
    var Shownifty_scoreBoard = `
// case 40: -- AMFnifty_scoreBoardA
// A concurrent computation of pi using Nilakantha's formula.
// by Diego Brener diegosilva13 on Github 
// ******* nifty scoreboard ***********************************
...
func ShowBBPfConcurent() {  // case 3:
    fmt.Print(string(colorCyan))
    var ShowBBPfConcurent = `
// case 41: // -- AMFBBPfConcurentA
func BBPfConcurent(selection int){  
    usingBigFloats = false
    workerCount := 4
...
func ShowLeibniz_method_one_billion_iters() {  // case 3:
    fmt.Print(string(colorCyan))
    var ShowLeibniz_method_one_billion_iters = `
...
func ShowdeleteAllLogFiles() {  // case 3:
    fmt.Print(string(colorCyan))
    var ShowdeleteAllLogFiles = `
func deleteAllLogFiles() {  // case 999: // -- AMFdeleteAllLogFilesA
    // list the files to be deleted: 
    filename111 := "dataLog-From_calculate-pi-and-friends.txt"
    filename112 := "dataLog-From_BBPfConcurent.txt"
...
func ShowNilakantha_Somayaji_with_big_Float_types() {  // case 3:
    fmt.Print(string(colorCyan))
    var ShowNilakantha_Somayaji_with_big_Float_types = `
// case 5: // -- AMFNilakantha_Somayaji_with_big_Float_typesA
func Nilakantha_Somayaji_with_big_Float_types(selection int) {
...
func ShowcompareFloat64withBigFloats() {  // case 3:
    fmt.Print(string(colorCyan))
    var ShowcompareFloat64withBigFloats = `
// case 50: // -- AMFcompareFloat64withBigFloatsA
// comparison of float64 vs big.Float types using a Nilakantha Somayaji example 
// π = 3 + 4/(2*3*4) - 4/(4*5*6) + 4/(6*7*8) - 4/(8*9*10) + 4/(10*11*12) ...
// Rick just loves github.com, Sublime Text, and Go.lang 
...
func ShowGauss_Legendre() {  // case 3:
    fmt.Print(string(colorCyan))
    var ShowGauss_Legendre = `
// case 37: // -- AMFGauss_LegendreA
func Gauss_Legendre(selection int) {  
    usingBigFloats = false
        start := time.Now()
