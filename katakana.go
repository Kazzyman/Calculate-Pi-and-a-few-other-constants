/* "ア, あ",  a - looks nothing like the hiragana a, but a lot like a te, fuck me
	"イ, い",  i - also looks more like a hiragana te, but at least it is still two mostly-vertical lines 
	"ウ, う",  u - is ok, having had to look for angles 
	...
	"ゲ, げ", 
	"ゴ, ご", 
	"キャ, きゃ",  the ya is ok, I guess. It is all about angles, apparently 
	"キュ, きゅ",  the yu is not even close though, but they had to have their sharp angles 
	"キョ, きょ",  the yo is also not even close, but they wanted sharp angles, and got Every one ヨ　 
	"ギャ, ぎゃ",  ... 
	"ギュ, ぎゅ",  
	"ギョ, ぎょ",  
	...
	"ニュ, にゅ", 
	"ニョ, にょ",
	"ハ, は",  ha - still looks like an H at least
	"ヒ, ひ",  hi - um, no! um-K 
	"フ, ふ",  hu - no! Wait, if we squint? 
	"ヘ, へ",  he - the haystack gets a sharpy 
	"ホ, ほ",  ho - looks more like a hoe now, I suppose
	"ヘ, へ",  ... 
	"ホ, ほ",     
	"バ, ば", 
	"ビ, び", 
