...
//func doTheRest(pattern1 *regexp.Regexp, pattern2 *regexp.Regexp, file *os.File) {
func doTheRest(pattern1 *regexp.Regexp, pattern2 *regexp.Regexp) {
