...
p("12:  Bailey–Borwein–Plouffe (BBP) formula for π, discovered in 1995\n")
...
fmt.Println("Ctrl-C to End/Exit  SLOC = 1426   \u00a9 2022, by Richard Hart Woolley \n")
}
...
if num > 12 && num < 100 { num = 17 }  // to display a funny out-of-range message as case 16:
...
case 12:
  fmt.Println("How many digits of pi should we calculate? '4 to 16' ")
  fmt.Scanf("%f", &numAi)
