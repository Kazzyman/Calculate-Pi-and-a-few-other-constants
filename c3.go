...
import (
    ...
    //"testing"   // Used in odd hexidecimal -- Rick "compiled" this package from claygod's collection of go modules 
)
...
func Leibniz_method_one_billion_iters(){
    /**
...
fmt.Println("Ctrl-C or 58 to End/Exit  SLOC = 4000ish   \u00a9 2023, by Richard Hart Woolley \n")
}
...
func secondMenu(){
    ...
    fmt.Println("44:  Pi: via Leibniz method in one billion iterations\n")
    fmt.Println("45: \n")
    fmt.Println("46: \n\n")
    //fmt.Print("Enter your selection from above, 19 - 46 \u00a9 2022, by Richard Hart Woolley\n")
    // the above kluge is definately not needed in a Linux environment
    fmt.Println("47: to End/Exit  SLOC = 4000ish   \u00a9 2023, by Richard Hart Woolley \n")
    var num2 int 
    ...
    switch num2 { 
        ...
        case 44:
            Leibniz_method_one_billion_iters()
        case 45:
